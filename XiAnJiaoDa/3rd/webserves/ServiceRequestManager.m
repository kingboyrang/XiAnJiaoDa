...
- (NSString*)syncronousWithData:(NSData**)repData error:(NSError**)error{
    ...
    *repData=responseData_;
    *error=error_;
    return [self responseString];
    //return [[NSString alloc] initWithData:responseData_ encoding:NSUTF8StringEncoding];
}
